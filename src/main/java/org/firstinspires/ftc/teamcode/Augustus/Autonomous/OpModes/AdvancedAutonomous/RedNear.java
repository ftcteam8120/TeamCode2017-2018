...
@Autonomous(name = "AdvancedAutoRedNear", group = "Augustus")
public class RedNear extends OpMode {
    ...
    public void init() {
        ...
        handler = new AutonomousHandler(augustus, Side.RED, Section.NEAR, new AdvancedAutonomous(1, relicTrackables.get(0)));
    }
