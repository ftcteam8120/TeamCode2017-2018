...
@Autonomous(name = "AdvancedAutoBlueFar", group = "Augustus")
public class BlueFar extends OpMode {
    ...
    public void init() {
        ...
        handler = new AutonomousHandler(augustus, Side.BLUE, Section.FAR, new AdvancedAutonomous(1, relicTrackables.get(0)));
    }
