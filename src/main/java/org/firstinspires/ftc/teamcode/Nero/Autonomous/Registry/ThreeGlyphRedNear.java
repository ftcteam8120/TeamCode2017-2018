...
@Autonomous(name = "NeroAutoRedNear3", group = "Nero")
public class ThreeGlyphRedNear extends OpMode
{
    ...
    public void init() {
        ...
        handler = new AutonomousHandler(nero, RED, NEAR, new ThreeGlyphAutonomous(relicTrackables.get(0)));
    }
