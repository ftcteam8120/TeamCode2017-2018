...
@Autonomous(name = "NeroAutoRedNear0", group = "Nero")
public class NoGlyphRedNear extends OpMode
{
    ...
    public void init() {
        ...
        handler = new AutonomousHandler(nero, RED, NEAR, new NoGlyphAutonomous());
    }
