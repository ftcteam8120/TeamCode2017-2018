...
@Autonomous(name = "NeroAutoBlueFar3", group = "Nero")
public class ThreeGlyphBlueFar extends OpMode
{
    ...
    public void init() {
        ...
        handler = new AutonomousHandler(nero, BLUE, FAR, new ThreeGlyphAutonomous(relicTrackables.get(0)));
    }
