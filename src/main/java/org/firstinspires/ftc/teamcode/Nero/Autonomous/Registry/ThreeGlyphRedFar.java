...
@Autonomous(name = "NeroAutoRedFar3", group = "Nero")
public class ThreeGlyphRedFar extends OpMode
{
    ...
    public void init() {
        ...
        handler = new AutonomousHandler(nero, RED, FAR, new ThreeGlyphAutonomous(relicTrackables.get(0)));
    }
